...
<main class="overflow-hidden">
    <section class="page-hero" style="--page-image:url('https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=1800&q=85')">
    ...
    <section class="section-light contact-page-section" style="padding-top:3rem">
        <div class="container-wide grid gap-10 lg:grid-cols-[.9fr_1.1fr] lg:items-start">
            <div class="contact-page-info reveal lg:sticky lg:top-28">
                ...
                <p class="mt-4 max-w-xl leading-7 text-slate-400">Prefer email or phone? Reach us directly — average response time under 4 hours on weekdays.</p>
                ...
                <div class="mt-8 grid gap-3">
                    ...
                    <a href="tel:{{ preg_replace('/\s+/', '', $settings['contact_phone'] ?? '+919876543210') }}" class="contact-direct-card">
                        ...
                        <div><div class="text-xs font-bold uppercase tracking-widest text-slate-400">Phone / WhatsApp</div><div class="font-bold text-white group-hover:text-emerald-300">{{ $settings['contact_phone'] ?? '+91 98765 43210' }}</div></div>
                    </a>
            ...
            <form method="post" action="{{ route('contact.store') }}" class="contact-card contact-page-form reveal">
                ...
                <div class="contact-page-fields">
                    ...
                    <label><span>Phone number <small>Optional</small></span><input class="field-dark" name="phone" value="{{ old('phone') }}" placeholder="+91 98765 43210"></label>
